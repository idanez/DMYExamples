...
public class AnimatedIconTreeExample extends JFrame {
  ...
  public AnimatedIconTreeExample() {
    ...
    String icon = "images/fire_ring.jpg";
    
    nodes[2].setIcon(new ImageIcon(icon));
    nodes[3].setIcon(new ImageIcon(icon));
    nodes[5].setIcon(new ImageIcon(icon));
    nodes[6].setIcon(new ImageIcon(icon));
    nodes[7].setIcon(new ImageIcon(icon));
