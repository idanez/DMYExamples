...
public class MidiSynth extends JPanel implements ControlContext {
	...
	/**
	 * given 120 bpm: (120 bpm) / (60 seconds per minute) = 2 beats per second 2 / 1000 beats per millisecond (2 * resolution) ticks per second (2 *
	 * resolution)/1000 ticks per millisecond, or (resolution / 500) ticks per millisecond ticks = milliseconds * resolution / 500
	 */
	...
	class InstrumentsTable extends JPanel {
		...
		private String names[] = { "Piano", "Chromatic Perc.", "Organ", "Guitar", "Bass", "Strings", "Ensemble", "Brass", "Reed", "Pipe",
