...
public class StreamingMediaPlayer extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        //scene.getStylesheets().add("resources/OverlayMediaPlayer.css");
        playerPane.getStylesheets().add(StreamingMediaPlayer.class.getResource("OverlayMediaPlayer.css").toExternalForm());
